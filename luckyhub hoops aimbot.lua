local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/CoolKid52321/zrezrzerz/main/src.lua.txt"))()
local window = lib:Window("LuckyHub | Hoopz", "Name", Enum.KeyCode.RightControl)

local main = window:Tab("Main")
local extra = window:Tab("Extra")

-- ui things(main stuff)
main:Toggle('Aimbot',function(v)
    _G.Aimbot=v
end)

main:Toggle('Reach',function(v)
    _G.Reach=v
end)
main:Toggle('Autoguard (Work in progress)',function(v)
    _G.Autoguard=v
end)

main:Slider('Walkspeed',16,19,0,function(v)
    game:GetService("Players").LocalPlayer.Character.Humanoid.WalkSpeed = v
end)

-- extra things for ui 

extra:Toggle("Aimbot Checker", function(v)
    _G.Aimbotchecker=v 
end) 

extra:Toggle('                                    Headless',function(v)
    if v == true then 
...
extra:Button('Free Limiteds Script',function()
    loadstring('https://raw.githubusercontent.com/CoolKid52321/jfasjnkjnkofashbjo/main/Protected%20(1).lua')()
end)
...
function stepped() pcall(function()
    if plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") and _G.Aimbot then
        ...
        if root and hasBall and _G.Aimbotchecker==true then
